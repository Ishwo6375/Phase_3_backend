...
Menu.create(
food_name: 'Daal Bhaat', 
description: 'Nepali food with rice along with meat, lentil soup and vegetable curry',
...
description: 'Chinese dish with beef with mix vegetables',
...
Menu.create(
food_name: 'Bhorta', 
description: 'Combinations of mashed herbs vegetables or fish',
...
description: 'A platter of leftover rice soaked in water and served with fried hilsa, achar, and dal',
